...
igrac = Player(pygame.image.load("Slike/tutorial/player.png") , Vector2(0 , 0) , Vector2(0 , 0) , True)
...
backtomainmenu = Dugme(pygame.image.load("Slike/settings/backtomainmenu.png") , (20 ,520))
    ...
    while program_radi:
        for dogadjaj in pygame.event.get():
            ...
            if dogadjaj.type == pygame.MOUSEBUTTONDOWN:
                if settings_dugme.slika.get_rect().move(settings_dugme.pozicija).collidepoint(dogadjaj.pos):
                    settings()
                if play_button.slika.get_rect().move(play_button.pozicija).collidepoint(dogadjaj.pos):
                    tutorial()

        prozor.blit(pygame.image.load("Slike/main_menu/mainmenu_background.jpg") , (0,0))
        settings_dugme.draw()
        play_button.draw()
    ...
    while program_radi:
        for dogadjaj in pygame.event.get():
            if dogadjaj.type == pygame.QUIT:
                ...
                sys.exit()
            if dogadjaj.type == pygame.MOUSEBUTTONDOWN:
                if backtomainmenu.slika.get_rect().move(backtomainmenu.pozicija).collidepoint(dogadjaj.pos):
                    return
